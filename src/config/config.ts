export class Config {
  ...
  public static MSG = {
    ...
    CRIANDO_TAB_TIPOS_SERVICOS: "Preparando a tabela local: Tipos de Serviço",
    CRIANDO_TAB_ACOES: "Preparando a tabela local: Ações",
    CRIANDO_TAB_DEFEITOS: "Preparando a tabela local: Defeitos",
    CRIANDO_TAB_CAUSAS: "Preparando a tabela local: Causas",
    CRIANDO_TAB_PECAS: "Preparando a tabela local: Peças",
    CRIANDO_TAB_EQUIPAMENTOS_POS: "Preparando a tabela local: Equipamentos POS",
    CRIANDO_TAB_OPERADORAS: "Preparando a tabela local: Operadoras",
    CRIANDO_TAB_TIPOS_COMUNICACAO: "Preparando a tabela local: Tipos de Comunicação",
    CRIANDO_TAB_MOTIVOS_COMUNICACAO: "Preparando a tabela local: Motivos de Comunicação",
    CRIANDO_TAB_MOTIVOS_CANCELAMENTO: "Preparando a tabela local: Motivos de Cancelamento",
    CRIANDO_TAB_STATUS_SERVICO: "Preparando a tabela local: Status de Serviços",
    CRIANDO_TAB_DEFEITOS_POS: "Preparando a tabela local: Defeitos do POS",
    CRIANDO_TAB_FERRAMENTAS: "Preparando a tabela local: Ferramentas dos Técnicos",
    CRIANDO_TAB_EQUIPAMETNOS_CAUSAS: "Preparando a tabela local: Equipamentos e Causas",
    CRIANDO_TAB_DEFEITOS_CAUSAS: "Preparando a tabela local: Defeitos e Causas",
    CRIANDO_TAB_ACOES_CAUSAS: "Preparando a tabela local: Ações e Causas",
